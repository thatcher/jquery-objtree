...
it provides a thin wrapper around yusuke kawasaki's http://www.kawa.net/XML source code.  in particular
...
dang dawg! that blew my mind.  let's trun the tables real quick and show the xml to js conversion:
