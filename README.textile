...
<pre><code>
    ...
    var xml1 = _.js2xml( tree1 );        // object tree to XML source
    alert( "xml1: "+xml1 );

    var xml2 = '<?xml version="1.0"?><response><error>0</error></response>';
    var tree2 = _.xml2js( xml2 );        // XML source to object tree
...
<code><pre>
    ...
    var tree 	= _.xml2js( xmlsrc );
    var class 	= tree.span.$class;        # attribute
    var name  	= tree.span._text;         # text node
</code></pre>
